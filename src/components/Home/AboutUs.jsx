    ...
    <>
      ...
      <div ref={sectionRef} className="about-us-container">
        ...
        <div className={`text-container ${inView ? "animate" : ""}`}>
          ...
          <p>
            At Usha International, we take pride in curating an exquisite range
            of products that reflect the rich cultural heritage and
            craftsmanship of our artisans. Our offerings include aromatic
            spices, premium teas and coffees, elegant handicrafts, beautifully
            crafted furniture, and stylish clothing—each item designed to bring
            quality and charm into your life.
            <br />
            <br />
